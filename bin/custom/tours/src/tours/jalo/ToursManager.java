...
/**
 * This is the extension manager of the Tours extension.
 */
public class ToursManager extends GeneratedToursManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ToursManager.class);
	...
	{
		return (ToursManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ToursConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ToursManager() // NOPMD 
	{
		LOG.debug("constructor of ToursManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ToursManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ToursManager called, current tenant: {}", getTenant().getTenantID());
	}
