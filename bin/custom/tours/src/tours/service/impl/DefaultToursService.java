...
public class DefaultToursService implements ToursService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultToursService.class);
	...
	{
		return DefaultToursService.class.getResourceAsStream("/tours/sap-hybris-platform.png");
	}
